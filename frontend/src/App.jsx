...
const INITIAL_DATA = [
    ...
    { name: '佐藤 由美子', type: '時間限定社員', isRS: true, days: 23, shifts: ['④'], requests: '' },
    { name: '鈴木 加奈', type: '正社員', isRS: true, days: 23, shifts: ['④', '⑦'], requests: '' },
    { name: '高橋 忍', type: '準社員', isRS: false, days: 23, shifts: ['④'], requests: '' },
    { name: '渡辺 美咲', type: '準社員', isRS: false, days: 23, shifts: ['④'], requests: '' },
    { name: '伊藤 隆', type: '準社員', isRS: false, days: 23, shifts: ['⑦'], requests: '' },
    { name: '山本 翼', type: '早ロングパート', isRS: false, days: 20, shifts: ['③'], requests: '' },
    { name: '小林 希', type: '早ロングパート', isRS: false, days: 20, shifts: ['③'], requests: '' },
    { name: '加藤 夕子', type: '中ロングパート', isRS: false, days: 20, shifts: ['⑤'], requests: '' },
    { name: '吉田 真美', type: '遅ロングパート', isRS: false, days: 20, shifts: ['⑧'], requests: '' },
    { name: '山田 くるみ', type: '早パート', isRS: false, days: 16, shifts: ['②'], requests: '' },
    { name: '佐々木 美佳', type: '早パート', isRS: false, days: 16, shifts: ['①'], requests: '' },
    { name: '松本 香織', type: '早パート', isRS: false, days: 16, shifts: ['①'], requests: '' },
    { name: '井上 妙子', type: '早パート', isRS: false, days: 16, shifts: ['①'], requests: '' },
    { name: '木村 真由美', type: '早パート', isRS: false, days: 16, shifts: ['①'], requests: '' },
    { name: '林 正浩', type: '中パート', isRS: false, days: 16, shifts: ['⑥'], requests: '' },
    { name: '斎藤 維新', type: '遅パート', isRS: false, days: 16, shifts: ['⑨'], requests: '' },
    { name: '清水 有一', type: '遅パート', isRS: false, days: 16, shifts: ['⑨'], requests: '' },
    { name: '山口 莉杏', type: '遅パート', isRS: false, days: 16, shifts: ['⑨'], requests: '' },
    { name: '森田 曜', type: '遅パート', isRS: false, days: 16, shifts: ['⑩'], requests: '' },
    { name: '池田 紘弥', type: '遅パート', isRS: false, days: 16, shifts: ['⑩'], requests: '' },
    { name: '橋本 明生', type: '遅パート', isRS: false, days: 16, shifts: ['⑩'], requests: '' },
    { name: '石川 佳奈', type: '遅パート', isRS: false, days: 16, shifts: ['⑪'], requests: '' },
    { name: '前田 春奈', type: '遅パート', isRS: false, days: 16, shifts: ['⑪'], requests: '' },
];
